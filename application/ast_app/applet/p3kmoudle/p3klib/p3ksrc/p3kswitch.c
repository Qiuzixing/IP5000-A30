...
int P3K_SilmpleReqCmdProcess(P3K_SimpleCmdInfo_S *cmdreq, P3K_SimpleCmdInfo_S *cmdresp, char *userdata)
{
	static P3K_PhraserToExecute_S cliFunc[] = {
		{"BEACON-CONF", P3K_ConfBeaconInfo, 2},		//for auto discovery
		{"BEACON-CONF?", P3K_GetBeaconConf, 0},		//for auto discovery
		...
		{"EDID-ADD", P3K_AddEDID, 2},	//notify for web
