        ...
        switch (key)
        {
            ...
            case ENTER_KEY:
            {
                do {
                    ...
                    {
                        if (SHOW_TIMEOUT == DEV_SETTINGS_P())
                        {
                            return SHOW_TIMEOUT;
                        }
                        break;
        ...
        switch (key)
        {
            ...
            case ENTER_KEY:
            {
                do {
                    ...
                    {
                        if (SHOW_TIMEOUT == LAN_STATUS_P(LAN1_ID_P))
                        {
                            return SHOW_TIMEOUT;
                        }
                        break;
                    ...
                    {
                        if (SHOW_TIMEOUT == LAN_STATUS_P(LAN2_ID_P))
                        {
                            return SHOW_TIMEOUT;
                        }
                        break;
        ...
        switch (key)
        {
            ...
            case ENTER_KEY:
            {
                do {
                    ...
                    {
                        if (SHOW_TIMEOUT == INPUT_SETTING_P())
                        {
                            return SHOW_TIMEOUT;
                        }
                        break;
                    ...
                    {
                        if (SHOW_TIMEOUT == EDID_SETTING_P())
                        {
                            return SHOW_TIMEOUT;
                        }
                        break;
                    ...
                    {
                        if (SHOW_TIMEOUT == HDCP_SETTING_P())
                        {
                            return SHOW_TIMEOUT;
                        }
                        break;
...
static int INPUT_SETTING_P()
{
    ...
    if (strstr(type, "hdmi.1") != NULL)
    {
        type_i = 1;
    }
    else if (strstr(type, "hdmi.2") != NULL)
    {
        type_i = 2;
    }
    else if (strstr(type, "usb.3") != NULL)
    {
        type_i = 3;
    }
